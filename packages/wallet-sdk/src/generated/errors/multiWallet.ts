...
/** PermanentMemberNotAllowed: Only one permanent member per wallet is allowed. */
...
export const MULTI_WALLET_ERROR__INSUFFICIENT_SIGNER_WITH_EXECUTE_PERMISSION = 0x1780; // 6016
/** InsufficientSignerWithInitiatePermission: At least one signer must have initiate permissions to perform this action. */
export const MULTI_WALLET_ERROR__INSUFFICIENT_SIGNER_WITH_INITIATE_PERMISSION = 0x1781; // 6017
...
export const MULTI_WALLET_ERROR__INSUFFICIENT_SIGNERS_WITH_VOTE_PERMISSION = 0x1782; // 6018
/** NoSignerFound: No valid signer was found in this transaction. */
export const MULTI_WALLET_ERROR__NO_SIGNER_FOUND = 0x1783; // 6019
...
export const MULTI_WALLET_ERROR__UNAUTHORISED_TO_CLOSE_TRANSACTION_BUFFER = 0x1784; // 6020
/** InvalidBuffer: The contents of the buffer do not match the expected hash. It may have been tampered with. */
export const MULTI_WALLET_ERROR__INVALID_BUFFER = 0x1785; // 6021
...
export const MULTI_WALLET_ERROR__MISSING_SYSVAR_SLOT_HISTORY = 0x178d; // 6029
/** InvalidSysvarDataFormat: Failed to parse sysvar: slot history format is invalid or corrupted. */
export const MULTI_WALLET_ERROR__INVALID_SYSVAR_DATA_FORMAT = 0x178e; // 6030
/** SlotNumberNotFound: The specified slot number is not present in the provided slot history. */
export const MULTI_WALLET_ERROR__SLOT_NUMBER_NOT_FOUND = 0x178f; // 6031
...
if (process.env.NODE_ENV !== 'production') {
  multiWalletErrorMessages = {
    ...
    [MULTI_WALLET_ERROR__PERMANENT_MEMBER_NOT_ALLOWED]: `Only one permanent member per wallet is allowed.`,
