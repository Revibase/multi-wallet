...
/** Backend authorization failed. */
export class RevibaseApiError extends RevibaseError {
  constructor(message: string) {
    super(message, "API_FAILED");
    this.name = "RevibaseApiError";
    Object.setPrototypeOf(this, RevibaseApiError.prototype);
  }
}
