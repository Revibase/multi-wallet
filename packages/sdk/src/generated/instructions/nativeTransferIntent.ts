...
export const NATIVE_TRANSFER_INTENT_DISCRIMINATOR = new Uint8Array([
  57, 156, 213, 157, 88, 202, 2, 151,
]);
...
> = {
  ...
  accounts: {
    ...
    slotHashSysvar: TAccountMetas[1];
